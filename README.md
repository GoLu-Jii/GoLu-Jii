...
![FastAPI](https://img.shields.io/badge/FastAPI-161B22?style=flat-square&logo=fastapi&logoColor=009688&labelColor=0D1117)
![Groq](https://img.shields.io/badge/Groq-161B22?style=flat-square&logo=groq&logoColor=F55036&labelColor=0D1117)
...
![Tailwind CSS](https://img.shields.io/badge/Tailwind_CSS-161B22?style=flat-square&logo=tailwindcss&logoColor=06B6D4&labelColor=0D1117)
...
> ### 🟢 [CODE Sherpa](https://code-sherpa-mu.vercel.app/)
...
>
> `Stack:` `Python` `FastAPI` `ChromaDB` `React` `Groq`  
> `STDOUT:` **[ GitHub ](https://github.com/GoLu-Jii/CODE_Sherpa)** `|` **[ Live Demo ](https://youtu.be/iz0Rq9VYDA4)**

<br>

> ### 🟢 [PDF-RAG-APP](https://huggingface.co/spaces/Joshijii/PDF-RAG-APP)
> **End-to-end RAG system for PDF Q&A** > Citation-enforced answers, score-threshold retrieval, Qdrant vector search.
>
> `Stack:` `FastAPI` `Qdrant` `Groq` `Docker`  
> `STDOUT:` **[ Space Demo ](https://huggingface.co/spaces/Joshijii/PDF-RAG-APP)**
